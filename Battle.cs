...
namespace Pr5
{
    public class Battle
    {
        ...
        {
            mage1.OnAttack += HandleMageEvent;
            mage1.OnDefend += HandleMageEvent;
            mage2.OnAttack += HandleMageEvent;
            mage2.OnDefend += HandleMageEvent;
        ...
        private static void HandleMageEvent(object sender, MageEventArgs e)
        {
